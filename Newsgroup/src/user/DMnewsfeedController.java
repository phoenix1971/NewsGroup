 ...
 * @author saad
 */
public class DMnewsfeedController implements Initializable  {
...
//    
    ...
    {
        // TODO
        System.out.println("initialize DSnewsfeed.....");
        ...
        try {
            ...
            Logger.getLogger(DMnewsfeedController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void PostIt(ActionEvent event) throws Exception 
    {
        ...
        System.out.println("In DM newpost is : " +  NewPost ) ; 
        System.out.println("NumberOfPost Is  : " + numberOfPosts ) ;
        newPost.setText("") ;
