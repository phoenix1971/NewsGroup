 ...
 * @author saad
 */
public class OOPReadWriteThread implements Runnable 
{
	private Thread thr;
	...
	public OOPReadWriteThread(NetworkUtilities nc) 
        {
		this.nc = nc;               
	...
	public void run() 
        ...
        {
            String filename = "OOPnewsfeed" + PostNo + ".txt";
            File file ;
        ...
        String numberOfPostIs() throws FileNotFoundException, IOException
        {
            ...
            File file ;
            file = new File("OOPnewsfeedPost.txt" );
            FileReader filereader = new FileReader(file ) ;
            char data[]=new char[(int)file.length()];
            System.out.println("data size is now" + data.length ) ;
            filereader.read(data);
        ...
        {
            String filename = "OOPnewsfeedPost.txt";
        ...
        void UpdateComment( String Post , String PostNo , String ClientName ) throws IOException
        {
            ...
            String UpdatedNotification = ClientName + " commented on the "+PostNo+"th post in the OOP course \n\n"+ oldNotification ;
        ...
        void UpdateNewPost( String NewPost , String PostNo , String ClientName ) throws IOException
        {
            ...
            System.out.println("oldnotification is " + oldNotification );
            System.out.println("username is " + ClientName ) ;
            String UpdatedNotification = ClientName + "  posted in the OOP course \n\n"+ oldNotification ;
            filewriter = new FileWriter(filename) ;
            filewriter.write(UpdatedNotification);
            filewriter.close();
            System.out.println("update notification in file "+ Post ) ;
