 ...
 * @author saad
 */
public class DMReadWriteThread implements Runnable 
{
	private Thread thr;
	...
	public DMReadWriteThread(NetworkUtilities nc) 
        {
		this.nc = nc;               
	...
	public void run() 
        {
            try 
            {
                System.out.println("DMReadWriteThreadWOrking..............");
        ...
        {
            String filename = "DMnewsfeed" + PostNo + ".txt";
            File file ;
        ...
        String numberOfPostIs() throws FileNotFoundException, IOException
        {
            ...
            File file ;
            file = new File("DMnewsfeedPost.txt" );
            FileReader filereader = new FileReader(file ) ;
            char data[]=new char[(int)file.length()];
            System.out.println("data size is now" + data.length ) ;
            filereader.read(data);
        ...
        {
            String filename = "DMnewsfeedPost.txt";
        ...
        void UpdateComment( String Post , String PostNo , String ClientName ) throws IOException
        {
            ...
            System.out.println("data of notification file is " + filename.length() ) ;
            ...
            String UpdatedNotification = ClientName + " commented on the "+PostNo+"th post in the DM course \n\n"+ oldNotification ;
        ...
        void UpdateNewPost( String NewPost , String PostNo , String ClientName ) throws IOException
        {
            ...
            System.out.println("In datastructure update new post in file "+ NewPost ) ;
            filewriter.close();   
            ...
            System.out.println("oldnotification is " + oldNotification );
            System.out.println("username is " + ClientName ) ;
            String UpdatedNotification = ClientName + "  posted in the DM course \n\n"+ oldNotification ;
            filewriter = new FileWriter(filename) ;
            filewriter.write(UpdatedNotification);
            filewriter.close();
            System.out.println("update notification in file "+ Post ) ;
